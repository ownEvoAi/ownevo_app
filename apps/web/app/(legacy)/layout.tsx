...
// (legacy) route group — wraps the flat routes (/inbox,
// /proposals/[id], /workflows/preview) in the simple pre- shell.
// 's customer-facing UI lives at /workspaces/[wsId]/... with a
