...
export const TABLE_DEMO: TableData = {
 ...
 rows: [
 { sku: 'BOOT- ', desc: "Winter trail boot, men's", forecast: 1847, onhand: 312, exposure: '$48k', risk: 'High' },
 { sku: 'BOOT- ', desc: "Winter trail boot, women's", forecast: 1422, onhand: 280, exposure: '$22k', risk: 'Med' },
...
export const ALERT_DEMO: AlertItem[] = [
 {
 severity: 'high',
 title: 'Stockout forecast: BOOT- will hit 0 in 6 days',
