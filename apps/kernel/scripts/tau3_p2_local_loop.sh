...
#   $2  base url           http://localhost:1234/v1 (LMS) or :11434/v1 (Ollama)
...
#     "qwen/qwen3.6-35b-a3b" "http://localhost:1234/v1" "qwen36"
#
# Example — gemma4:26b on Ollama desktop:
#   bash scripts/tau3_p2_local_loop.sh \
#     "gemma4:26b" "http://localhost:11434/v1" "gemma4_26b"
set -u

if [[ $# -lt 3 ]]; then
    echo "usage: $0 <model> <base_url> <workflow_tag>" >&2
    echo "example: $0 'qwen/qwen3.6-35b-a3b' 'http://localhost:1234/v1' 'qwen36'" >&2
    exit 2
fi
