...
Same shape as NeoSigma auto-harness's `agent/templates/tau_bench.py` so
the iteration patterns documented in `notes_jit.txt` (multi-order ID
...
|---|---|
| NeoSigma published (GPT-5.4, no loop) | 0.560 |
