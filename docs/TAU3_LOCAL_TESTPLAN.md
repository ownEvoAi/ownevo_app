...
**qwen3.5 task agents (Runs 18/20/21/22 → 27/28):** Run 18 hit LMS jinja error ("No user query found"); user applied froggeric v13 template — fixed for both 4b and 9b. **Runs 21/22 PASS 0.825 / 0.725 were JIT-fallback to qwen3.6-35b-a3b** (Run 28 retest at real 9B + ctx=65k landed val=0.5750). **Real retail task-agent ranking: qwen3.6-35b-a3b (0.75) > qwen3.5-9b (0.575) > gpt-oss-20b (0.30) ≫ qwen3.5-4b (~0.30 diag).** Bigger > smaller, "inverse scaling" invalidated.
