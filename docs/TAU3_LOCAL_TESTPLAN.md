...
**Session totals (2026-05-10/11):** 18 attempts, **3 end-to-end val_score landings**:
...
- Run 18: `qwen36loop_qwen35_9b_lms_anthropic_smoke` (2026-05-11) — **in flight**. Mixed: qwen3.6-35b-a3b LMS loop + `anthropic/qwen/qwen3.5-9b` LMS task/user. Dodges Ollama entirely; per F14g qwen3.5-9b passes A4.4 only via anthropic/ routing.
