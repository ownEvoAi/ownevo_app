...
- Run 20 (queued): `qwen36loop_qwen35_9b_lms_anthropic_smoke_v2` — retry of Run 18 with froggeric v13 template now applied. Same topology (qwen3.6-35b-a3b loop + anthropic/qwen3.5-9b task/user). Transport confirmed working (#18); only template was broken.
